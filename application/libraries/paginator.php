...
class Paginator {
	...
	public static $full_tag_open		= '<div class="pagination"><ul>';
	public static $full_tag_close		= '</ul></div>';

	public static $next_link			= '&gt;';
	public static $prev_link			= '&lt;';
	public static $last_link			= 'Last &rsaquo;';
	public static $first_tag_open		= '';
	public static $first_tag_close		= '&nbsp;';
	public static $last_tag_open		= '&nbsp;';
	public static $last_tag_close		= '';
	public static $cur_tag_open			= '<li class="disabled">';
	public static $cur_tag_close		= '</li>';
	public static $next_tag_open		= '<li>';
	public static $next_tag_close		= '</li>';
	public static $prev_tag_open		= '<li>';
	public static $prev_tag_close		= '</li>';
	public static $num_tag_open			= '<li>';
	public static $num_tag_close		= '</li>';
	...
	public function links($adjacent = 3)
	{
		...
		return static::$full_tag_open.$content.static::$full_tag_close;
	}
	...
	protected function element($element, $page, $text, $disabled)
	{
		...
		{
			return static::$cur_tag_open.HTML::link('#', $text).static::$cur_tag_close;
		}
		else
		{
			return static::$num_tag_open.$this->link($page, $text, $class).static::$num_tag_close;
		}
	}
	...
	protected function range($start, $end)
	{
		...
		for ($page = $start; $page <= $end; $page++)
		{
			if ($this->page == $page)
			{
				$pages[] = static::$cur_tag_open.HTML::link($page,$page, array('onclick'=>'return false')).static::$cur_tag_close;
			}
			else
			{
				$pages[] = static::$num_tag_open.$this->link($page, $page, null).static::$num_tag_close;
			}
		}
